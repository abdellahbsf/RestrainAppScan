...
/**
 * REST controller for managing {@link com.ras.myapp.domain.Client}.
 */
@RestController
        ...
        Optional<Client> result = clientRepository
            ...
            .map(existingClient -> {
                if (client.getKeyId() != null) {
                    existingClient.setKeyId(client.getKeyId());
                }
                if (client.getKeySecret() != null) {
                    existingClient.setKeySecret(client.getKeySecret());
                }
