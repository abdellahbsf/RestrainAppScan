...
class ClientResourceIT {
    ...
    private static final String DEFAULT_KEY_SECRET = "AAAAAAAAAA";
    private static final String UPDATED_KEY_SECRET = "BBBBBBBBBB";
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().keyId(DEFAULT_KEY_ID).keySecret(DEFAULT_KEY_SECRET).token(DEFAULT_TOKEN);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().keyId(UPDATED_KEY_ID).keySecret(UPDATED_KEY_SECRET).token(UPDATED_TOKEN);
        return client;
    }
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getKeyId()).isEqualTo(DEFAULT_KEY_ID);
        assertThat(testClient.getKeySecret()).isEqualTo(DEFAULT_KEY_SECRET);
        assertThat(testClient.getToken()).isEqualTo(DEFAULT_TOKEN);
    }
    ...
    void getAllClients() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.[*].keySecret").value(hasItem(DEFAULT_KEY_SECRET)))
    ...
    void getClient() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.keySecret").value(DEFAULT_KEY_SECRET))
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.keyId(UPDATED_KEY_ID).keySecret(UPDATED_KEY_SECRET).token(UPDATED_TOKEN);
        ...
        Client testClient = clientList.get(clientList.size() - 1);
        assertThat(testClient.getKeyId()).isEqualTo(UPDATED_KEY_ID);
        assertThat(testClient.getKeySecret()).isEqualTo(UPDATED_KEY_SECRET);
        assertThat(testClient.getToken()).isEqualTo(UPDATED_TOKEN);
    }
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.keyId(UPDATED_KEY_ID).keySecret(UPDATED_KEY_SECRET);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.keyId(UPDATED_KEY_ID).keySecret(UPDATED_KEY_SECRET).token(UPDATED_TOKEN);
